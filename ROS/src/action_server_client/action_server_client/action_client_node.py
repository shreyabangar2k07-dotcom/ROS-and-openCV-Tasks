...
class CountDownActionClient(Node):
    ...
    def feedback_callback(self, feedback_msg):
        feedback = feedback_msg.feedback.current_count
        self.get_logger().info(f"current count: {feedback}")
...
def main(args=None):
    ...
    countdown_action_client = CountDownActionClient()
    countdown_action_client.send_goal(10)
    rclpy.spin(countdown_action_client)
